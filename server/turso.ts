...
const schemaStatements = [
  ...
  `CREATE TABLE IF NOT EXISTS tills (id INTEGER PRIMARY KEY AUTOINCREMENT, userId INTEGER NOT NULL, tillNumber TEXT NOT NULL, name TEXT NOT NULL, location TEXT, paymentType TEXT NOT NULL DEFAULT 'BUY_GOODS', businessShortcode TEXT, payoutPhone TEXT, isActive INTEGER NOT NULL DEFAULT 1, createdAt TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE(userId, tillNumber))`,
