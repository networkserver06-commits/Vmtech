              ...
              {group.items.map((item) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => { setActiveNav(item.label); setMobileOpen(false); if (item.label === "Collections") navigate("/collections"); }}
                  >
