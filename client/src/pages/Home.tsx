      ...
      <main className="main-content">
        ...
        <div className="content-wrap dashboard-tabs" data-active-tab={activeNav}>
          ...
          <section id="tills-panel" className="panel tills-panel tab-tills">
            <div className="panel-heading"><div><h3>Payout destinations</h3><p>Add one phone number, Buy Goods Till, or PayBill number for payouts.</p></div><span className="till-count">{visibleTills.length} configured</span></div>
