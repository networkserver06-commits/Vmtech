...
export default function PaymentLinkCheckout() {
  ...
  useEffect(() => {
    ...
    void poll();
    const timer = window.setInterval(() => { attempts += 1; if (attempts >= 150) window.clearInterval(timer); else void poll(); }, 2000);
