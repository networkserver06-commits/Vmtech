...
export default function Login() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "register") {
        setNotice(body.verificationSent ? "Account created. Check your inbox to verify your email, then sign in." : "Account created, but the verification email could not be sent. Check your email address and resend it below.");
