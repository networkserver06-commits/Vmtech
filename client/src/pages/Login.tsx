...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (params.get("verified") === "1") setNotice("Email verified successfully. You can now sign in.");
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === "register") { setNotice("Account created. Check your inbox and verify your email before signing in."); setMode("login"); setForm({ name: "", email: form.email, password: "", confirmPassword: "" }); }
